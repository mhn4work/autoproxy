...
namespace AutoProxy
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("*************Auto Proxy Config*************\n");
            Console.WriteLine("Choose 0 or 1 to ON/OFF the proxy\n");
            Console.WriteLine("1: Turn On Proxy\n");
            Console.WriteLine("0: Turn Off Proxy\n");
